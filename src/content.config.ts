 ...
 * (e.g. '...home-lab copy.md' -> '...home-lab-copy'), so permalinks are
 * preserved. Upstream needs a custom generateId only because their posts are
 * nested as <year>/<name>/index.mdx.
 */
