...
export const { AUTHOR_GITHUB, AUTHOR_LINKEDIN, AUTHOR_TWITTER, AUTHOR_YOUTUBE, BUSINESS_URL } = CONFIG_CLIENT;
...
I build and ship SaaS products, AI automations, and integrations that reduce delivery time and engineering overhead.
I am based in South Korea and work remotely with clients worldwide, mainly EU teams. I am a senior full-stack engineer focused on turning complex requirements into reliable production systems. Over the years, I have worked with Java, PHP, Node.js, and Python while evolving into modern AI-assisted workflows, automation pipelines, and scalable web architecture.
I am also passionate about self-hosting and home-lab tinkering.

My hobbies are ethical hacking, coding, reading, playing football and DIY electronics.

For work enquiries about SaaS delivery, AI automation, integrations, or platform engineering, my business is <Link href={BUSINESS_URL} target="_blank">ITQuaLab</Link>. You can also reach me directly via:


<p class="my-2 flex gap-1 flex-col xs:flex-row">
  <label class="font-bold">Business:</label>
  <Link href={BUSINESS_URL} target="_blank">{BUSINESS_URL}</Link>
</p>
<p class="my-2 flex gap-1 flex-col xs:flex-row">
...
I have been working professionally as a software engineer since 2001. I have started as a web developer. Since then, I have narrowed my specialisation from a general front and back-end developer toward quality assurance and automation testing. 
